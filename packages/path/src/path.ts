 ...
 * @example
 * ```typescript
 * import { getPackageRoot } from "commonxjs/path";
 *
 * const pkgRoot = getPackageRoot(import.meta);
 * // e.g., /Users/sean/my-project
 * ```
 */
 ...
 * @example
 * ```typescript
 * import { getMonorepoRoot } from "commonxjs/path";
 *
 * const root = getMonorepoRoot(import.meta);
 * // e.g., /Users/sean/my-monorepo
 * ```
 */
 ...
 * @example
 * ```typescript
 * import { resolveFromRoot } from "commonxjs/path";
 *
 * const dataDir = resolveFromRoot(import.meta, "data");
 * // e.g., /Users/sean/my-monorepo/data
 *
 * const config = resolveFromRoot(import.meta, "packages", "config", "settings.json");
 * // e.g., /Users/sean/my-monorepo/packages/config/settings.json
 * ```
 */
 ...
 * @example
 * ```typescript
 * import { resolveFromPackage } from "commonxjs/path";
 *
 * const testsDir = resolveFromPackage(import.meta, "tests");
 * // e.g., /Users/sean/my-project/tests
 *
 * const fixtures = resolveFromPackage(import.meta, "tests", "fixtures", "data.json");
 * // e.g., /Users/sean/my-project/tests/fixtures/data.json
 * ```
 */
